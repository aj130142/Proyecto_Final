    ...
    public partial class GestionarStock : Form
    {
        ...
        private void btnRegistrar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int cantidadActual = (int)tbProductoTableAdapter1.ObtenerCantidadProductoPorId(Convert.ToInt32(codigoProducto));
                ...
                // 5. Insertar datos en la tabla de movimientos de stock
                ...
                tbProductoTableAdapter1.ActualizarCantidadProducto(cantidadActual, Convert.ToInt32(codigoProducto));
